...
let CANISTER_IDS: (CANISTERS_NAME_NO_PIC | Principal)[][] = [
  ...
  [
    CANISTERS_NAME_NO_PIC.ACCOUNTS,
    Principal.fromText("222qi-2qaaa-aaaao-anesa-cai"),
  ],
  [
    CANISTERS_NAME_NO_PIC.INSURANCE,
    Principal.fromText("suaf3-hqaaa-aaaaf-bfyoa-cai"),
  ],
  [
    CANISTERS_NAME_NO_PIC.OPTIONS,
    Principal.fromText("222iv-iiaaa-aaaak-qdyla-cai"),
  ],

  [
    CANISTERS_NAME_NO_PIC.KYT,
    Principal.fromText("pjihx-aaaaa-aaaar-qaaka-cai"),
  ],
  [
    CANISTERS_NAME_NO_PIC.CKUSDT_LEDGER,
    Principal.fromText("yfumr-cyaaa-aaaar-qaela-cai"),
  ],
];
